...
4/4 timeouts. This is the ping that actually proves the impact of the misconfiguration: off-subnet traffic requires the default gateway, and the PC's default gateway doesn't exist.
